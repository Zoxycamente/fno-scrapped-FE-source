...
class OriginalChartingState extends MusicBeatState
{
	...
	var NoteType:Int = coolNote.noteType;
	...
	**/
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>)
	{
		...
		else if (id == FlxUINumericStepper.CHANGE_EVENT && (sender is FlxUINumericStepper))
		{
			...
			switch (wname)
			{
				...
				case 'note_type':
					NoteType = Std.int(nums.value); // oh yeah dont forget this has to be an integer
	...
	override function update(elapsed:Float)
	{
		...
		switch (coolNote.noteType) {
			case 1:
				noteInfoShit = 'Alt anim';
			case 2:
				noteInfoShit = 'Terceiro player';
			case 3:
				noteInfoShit = 'Hey';
			case 4:
				noteInfoShit = 'No anim';
			default:
	...
	private function addNote():Void
	{
		...
		var noteType = NoteType; // define notes as the current type
